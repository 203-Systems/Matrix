void CDCDecode()
{
  switch (CDC.read())
  {
    case 0x00://0
      ...
      break;
    case 0x01://1
      LEDonRGB(CDC.read(), CDC.read(), CDC.read(), CDC.read(), CDC.read()); //XYRGB
      break;
    case 0x02://2
      LEDonWRGB(CDC.read(), CDC.read(), CDC.read(), CDC.read(), CDC.read(), CDC.read()); //XYRGBW
      break;
    case 0x03://3
      LEDonW(CDC.read(), CDC.read(), CDC.read()); //XYW
      break;
    case 0x04://4
